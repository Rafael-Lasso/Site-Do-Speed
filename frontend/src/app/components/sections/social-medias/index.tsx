        ...
        <div className="container-notices flex flex-wrap  justify-center items-center">
          ...
          <nav className="flex flex-col items-center justify-center">
            ...
            <div className="content-filter-topic flex flex-wrap justify-center">
              <Link href={"https://www.youtube.com/@SpeedUzumaki"}>
              ...
              <Link href={"https://www.tiktok.com/@speeduzumaki"}>
                <div className="filter-topic bg-gray-400 w-20 h-20 mx-2 flex justify-center items-center rounded-full cursor-pointer hover:bg-speedOrange transition-all">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="35"
              ...
              <Link
                href={
                  "https://www.facebook.com/people/Speed-Uzumaki/100087658766638/"
                }
              >
                <div className="filter-topic bg-gray-400 w-20 h-20 mx-2 flex justify-center items-center rounded-full cursor-pointer hover:bg-speedOrange transition-all">
                  <svg
              ...
              <Link href={"https://discord.gg/aNNnm5gQrs"}>
                <div className="filter-topic bg-gray-400 w-20 h-20 mx-2 flex justify-center items-center rounded-full cursor-pointer hover:bg-speedOrange transition-all">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="35"
